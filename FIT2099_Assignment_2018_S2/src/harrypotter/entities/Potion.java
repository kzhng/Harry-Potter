...
public class Potion extends HPEntity{
	 ...
	 * 	<li>Add a <code>Take</code> affordance to this <code>Potion</code> so it can be taken</li> 
	...
	public Potion(MessageRenderer m) {
		...
		this.hitpoints = (int) Math.round(( Math.random()*30 ) + 1); // randomized hitpoints with a maximum of 30 hitpoints
																	 //mh need to somehow make sure its always positive
	...
	/**
	 * A symbol that is used to represent the health Potion on a text based user interface
	 * 
	 ...
	 * 
	 */
	public void addHitPoints(HPActor a) {
