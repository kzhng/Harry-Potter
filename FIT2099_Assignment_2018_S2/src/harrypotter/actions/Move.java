...
/**
 * <code>HPAction</code> that lets <code>HPActor</code>s walk around the map.
 * 
 * @author ram
 */
/*
 ...
 */
public class Move extends HPAction {
	 ...
	 */
	public Move(Direction d, MessageRenderer m, HPWorld world) {
		super(m);
	 ...
	 * <p>
	 * If it is possible for <code>HPActor a</code> to move in the given direction, tell the world to move them
